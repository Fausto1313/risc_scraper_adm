...
public class Customer implements Serializable {
    ...
    public Customer portals(Set<Portal> portals) {
        this.portals = portals;
        return this;
    }

    public Customer addPortal(Portal portal) {
        this.portals.add(portal);
        portal.setCustomer(this);
        return this;
    }

    public Customer removePortal(Portal portal) {
        this.portals.remove(portal);
        portal.setCustomer(null);
        return this;
    }
