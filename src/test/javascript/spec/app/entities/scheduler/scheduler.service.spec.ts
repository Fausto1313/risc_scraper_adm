...
describe('Service Tests', () => {
    describe('Scheduler Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Scheduler(0, 'AAAAAAA', 0, 0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', currentDate, 0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Scheduler', async () => {
                const returnedFromService = Object.assign(
                    {
                        identifier: 'BBBBBB',
                        status: 1,
