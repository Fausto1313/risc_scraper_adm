...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("risc_scraper_adm");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("risc_scraper_adm");
        ...
        config.getMapConfigs().put("mx.com.risc.scraper.domain.*", initializeDomainMapConfig(jHipsterProperties));
