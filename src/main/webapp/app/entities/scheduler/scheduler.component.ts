...
export class SchedulerComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.schedulerService
            ...
            .subscribe(
                (res: HttpResponse<IScheduler[]>) => this.paginateSchedulers(res.body, res.headers),
    ...
    registerChangeInSchedulers() {
        this.eventSubscriber = this.eventManager.subscribe('schedulerListModification', response => this.loadAll());
    }
